function processListeningData(inCsvFiles, outGroupedFile, verbose, groupOnFileName, unpackFn)
...
%   groupOnFileName  Remove directory from names of stimulus files (in case
%                    different subjects had them in different directories)


if ~exist('unpackFn', 'var') || isempty(unpackFn), unpackFn = @unpackShsCsv; end
if ~exist('groupOnFileName', 'var') || isempty(groupOnFileName), groupOnFileName = 0; end
